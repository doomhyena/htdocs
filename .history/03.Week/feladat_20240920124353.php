...
// Töltsük fel a tömböt 100 random számmal 0 és 5 között
for ($i = 0; $i < 100; $i++) {
    $rando = rand(0, 5);
...
// Számoljuk meg, hányszor szerepel 0 a listában
for ($i = 0; $i < count($listas); $i++) {  // Javítás: 'listas'
    if ($listas[$i] === 0) {  // Javítás: 'listas'
        $nullak += 1;
    }
}

...
5. Feladat
    ...
    Feladat: Hozz létre egy $szam változót, amely egy pozitív egész számot tartalmaz. Írj egy programot, amely kiszámolja és kiírja a szám faktoriálisát! (A faktoriális egy szám összes pozitív egész számú osztójának szorzata, pl. 5 faktoriálisa: 5*4*3*2*1 = 120).
